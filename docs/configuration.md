...
```ini
greetingMessage[] = Welcome to Official Noob Advertising!
greetingMessage[] = Remember to read the rules before you start advertising. :wink:
```
...
{
  "greetingMessage": "Welcome to Official Noob Advertising!\
Make sure you read our rules before you start advertising."
}
```
